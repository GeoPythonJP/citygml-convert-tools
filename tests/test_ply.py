...
def test_ply_lod0():
    ...
    # ファイル比較
    output_answer_file = os.path.join(os.path.join(basedir, ANSWER), f"53392633_bldg_6677_lod0.ply")
    output_file = os.path.join(output_path_name, f"53392633_bldg_6677_lod0.ply")
    assert filecmp.cmp(output_answer_file, output_file)


def test_ply_separate_lod0():
    """PLY LOD0 (separate)"""
    # ベースディレクトリ
    basedir = Path(os.path.dirname(os.path.abspath(__file__)))
    pathname = os.path.join(basedir, DATA, "53392633_bldg_6697_2_op.gml")
    ...
    # 実行
    obj_city_gml = CityGml(pathname, Subset.PLY, "6677", separate=True)
    obj_city_gml.lod0()
    obj_city_gml.write_file(output_path_name)
...
def test_ply_lod1():
    ...
    # ファイル比較
    output_answer_file = os.path.join(os.path.join(basedir, ANSWER), f"53392633_bldg_6677_lod1.ply")
    output_file = os.path.join(output_path_name, f"53392633_bldg_6677_lod1.ply")
    assert filecmp.cmp(output_answer_file, output_file)


def test_ply_separate_lod1():
    """PLY LOD1 (separate)"""
    # ベースディレクトリ
    basedir = Path(os.path.dirname(os.path.abspath(__file__)))
    pathname = os.path.join(basedir, DATA, "53392633_bldg_6697_2_op.gml")
...
def test_ply_lod2():
    ...
    # ファイル比較
    output_answer_file = os.path.join(os.path.join(basedir, ANSWER), f"53392633_bldg_6677_lod2.ply")
    output_file = os.path.join(output_path_name, f"53392633_bldg_6677_lod2.ply")
    assert filecmp.cmp(output_answer_file, output_file)


def test_ply_separate_lod2():
    """PLY LOD2 (separate)"""
    # ベースディレクトリ
    basedir = Path(os.path.dirname(os.path.abspath(__file__)))
    pathname = os.path.join(basedir, DATA, "53392633_bldg_6697_2_op.gml")
